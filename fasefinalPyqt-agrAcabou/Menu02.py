...
class Ui_Menu02(object):
    def setupUi(self, Menu02):
        ...
        self.Botao_Manutencao.setGeometry(QtCore.QRect(300, 270, 240, 240))
...
"border-width:5px;")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("imagens/MANUTENCAO.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Botao_Manutencao.setIcon(icon)
        ...
        self.Botao_Cadastros.setGeometry(QtCore.QRect(650, 270, 240, 240))
...
"border-width:5px;")
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("imagens/CADASTROS.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Botao_Cadastros.setIcon(icon1)
...
"border-width:3px;")
        ...
        self.Botao_Seta_Direita.setIcon(icon2)
        self.Botao_Seta_Direita.setIconSize(QtCore.QSize(130, 130))
...
"border-width:3px;")
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap("imagens/Seta Preta para esquerda.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Botao_Seta_Esquerda.setIcon(icon3)
        self.Botao_Seta_Esquerda.setIconSize(QtCore.QSize(135, 135))
...
"}")
    ...
    def retranslateUi(self, Menu02):
        ...
        Menu02.setWindowTitle(_translate("Menu02", "MainWindow"))
        self.Botao_Manutencao.setWhatsThis(_translate("Menu02", "<html><head/><body><p><br/></p></body></html>"))
        self.Label_Menu_De_Usuario.setText(_translate("Menu02", "MENU DE USUÁRIO"))
        self.Label_Colaborador.setText(_translate("Menu02", "COLABORADOR:"))
        self.Label_EDV.setText(_translate("Menu02", "EDV:"))
