...
urlpatterns = [
    ...
    path("maintenances/<int:pk>/<int:status>/", MaintenanceAPI.as_view(), name="maintenancesParameters"),
    path("maintenances/<int:pk>/", PatchMaintenanceAPI.as_view(), name="maintenancesParameters"),
