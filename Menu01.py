...
"border-width:3px;")
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap("imagens/setadireitaFinapreta.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Botao_Seta_Direita.setIcon(icon4)
        self.Botao_Seta_Direita.setIconSize(QtCore.QSize(120, 280))
        ...
        self.Botao_Seta_Esquerda.setGeometry(QtCore.QRect(1000, 600, 121, 151))
...
"border-width:3px;")
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap("imagens/setaesquerdaFina.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.Botao_Seta_Esquerda.setIcon(icon5)
        self.Botao_Seta_Esquerda.setIconSize(QtCore.QSize(120, 280))
        self.Botao_Seta_Esquerda.setObjectName("Botao_Seta_Esquerda")
        self.Label_Menu_De_Usuario = QtWidgets.QLabel(self.centralwidget)
        self.Label_Menu_De_Usuario.setGeometry(QtCore.QRect(0, 40, 1281, 121))
...
"font: 75 15pt \"Bosch Sans Bold\";")
    ...
    def retranslateUi(self, Menu01):
        ...
        Menu01.setWindowTitle(_translate("Menu01", "MainWindow"))
        self.Botao_Liberar_Maquina.setWhatsThis(_translate("Menu01", "<html><head/><body><p><br/></p></body></html>"))
        self.Label_Menu_De_Usuario.setText(_translate("Menu01", "ACCESS CONTROL"))
