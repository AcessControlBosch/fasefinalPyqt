...
class Connection:
    ...
    def verifica_estado_de_manutencao(self, id_maquina):
        urlManutencao = self.url + 'maintenances/' + id_maquina + '/1/'
    ...
    def estado_manutencao(self, bool, maquina):
        ...
        postManutencao = self.url + 'maintenances/'
...
class Manutencao(QMainWindow, Ui_Manutencao):
    def __init__(self):
        ...
        if banco_dados.verifica_estado_de_manutencao(serra_de_perfil) == True:
            self.estado_manutencao = True  # ARRUMAR AQUI PARA APENAS ESTADO MANUTENCAO *************************************************************************
